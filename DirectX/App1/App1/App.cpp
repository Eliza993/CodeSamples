...
void App::SetWindow(CoreWindow^ window)
{
	...
	window->PointerExited +=
		ref new Windows::Foundation::TypedEventHandler<Windows::UI::Core::CoreWindow ^, Windows::UI::Core::PointerEventArgs ^>(this, &App1::App::OnPointerExited);
...
void App1::App::OnPointerExited(Windows::UI::Core::CoreWindow ^sender, Windows::UI::Core::PointerEventArgs ^args)
{
	diffx = 0;
	diffy = 0;
	left_click = false;
